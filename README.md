...
2. Optional über ⚙️ **Web-Konfiguration** eine eigene Application (Client) ID eintragen. Wenn das Feld leer bleibt, wird die Standard-ID aus `auth-config.js` verwendet.
